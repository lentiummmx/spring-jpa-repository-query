...
public class QueryHintsAspect {
    ...
    //org.hibernate.query.internal.AbstractProducedQuery.setHint(String hintName, Object value)

    //@Pointcut("target(org.springframework.data.jpa.repository.query.AbstractJpaQuery)")
    public void repositoryMethods() {}
    //@Pointcut("execution(* org.springframework.data.jpa.repository.query.AbstractJpaQuery.*applyHints*(..)) && args(query, method)")
    ...
    //@AfterReturning(value = "entityCreationMethods(joinPoint, query, method)", returning = "query")
    //@AfterReturning(value = "execution(* org.springframework.data.jpa.repository.query.AbstractJpaQuery.*applyHints*(..)) && args(query, method)", returning = "query")
    //@After(value = "execution(* org.springframework.data.jpa.repository.query.AbstractJpaQuery.applyHints(..))")
    //@Around(value = "execution(* org.springframework.data.jpa.repository.query.AbstractJpaQuery.applyHints(..))")
    ...
    @AfterReturning(
            pointcut = "execution(* org.hibernate.query.internal.AbstractProducedQuery.setHint(..))",
            returning= "result")
